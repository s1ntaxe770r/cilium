...
// allService is a resource.Resource[*slim_corev1.Service] but one which will only stream updates for
// headless Services.
type allService resource.Resource[*slim_corev1.Service]

// allEndpoint is a resource.Resource[*slim_corev1.Service] but one which will only stream updates for
// Endpoints from headless Services.
